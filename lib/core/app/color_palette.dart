...
class ColorPalette {
  static const primaryy = "#0b147c, #050d53, #040830,#0c1b96, #0f1992";

  // static const Color primary = Color(0xFF0B147C);
  static const Color primary = Color(0xFF2575d4);
  static const Color secondary = Color(0xFF2575d4);
  static const Color pinkShade = Color(0xFFF5D4E0);
  static const Color pinkShade1 = Color(0xFFF69197);
  static const Color blue = Color(0xff2A9DF4);
  ...
  static const Color green2 = Color(0xFF54B435);
  ...
  static const Color shimmer = Color.fromARGB(50, 50, 50, 0);
  static const Color blackText = Color(0xFF191919);
